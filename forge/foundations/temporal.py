...
class Temporal(object):
    """
    Accesses and compares items in three stages: before, present and after
    """

    def __init__(self, before, present, after, mirror):

        if after is None:
            after = before
        if mirror:
            after = reversed(after)
    ...
    def __str__(self):
        return '{}{}'.format(self.shape, self._entries_)

    def __repr__(self):

        #TODO Make Machine Representation
